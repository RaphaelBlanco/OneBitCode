const field = document.querySelectorAll('#game span')
let vBoard = []
let turnPlayer = ''
...
function initializeGame() {
    vBoard = [['', '', ''], ['', '', ''], ['', '', '']]
    turnPlayer = 'player1'
    document.querySelector('h3').innerHTML = 'Jogador: <span id="turnPlayer"></span>'
    updateTitle()
...
function handleWin(regions) {
    ...
    document.querySelector('h3').innerHTML = player + ' venceu!'
}
